    ...
    <div style="width: 90%; max-width: 600px; padding: 40px 30px; background-color: #fff; border-radius: 10px;">
        ...
        <table style="width: 100%; margin-bottom: 30px;">
            ...
            <tr>
                ...
                <td style="font-size: 18px; color: #333; padding-left: 10px; padding:5px; border-left: 2px solid #0066cc;">{{ $request->studentName ?? '' }}</td>
            </tr>
            <tr>
                <td style="font-size: 16px; font-weight: bold; color: #555;">Marks:</td>
                <td style="font-size: 18px; color: #333; padding-left: 10px; padding:5px; border-left: 2px solid #0066cc;">{{ $request->studentMark ?? '' }}</td>
            </tr>
            <tr>
                <td style="font-size: 16px; font-weight: bold; color: #555;">Grade:</td>
                <td style="font-size: 18px; color: #333; padding-left: 10px; padding:5px; border-left: 2px solid #0066cc;">{{ $request->studentGrade ?? '' }}</td>
            </tr>
            <tr>
                <td style="font-size: 16px; font-weight: bold; color: #555;">Comment:</td>
                <td style="font-size: 18px; color: #333; padding-left: 10px; padding:5px; border-left: 2px solid #0066cc;">{{ $request->studentComent ?? '' }}</td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin-bottom: 30px; ">
            <tr>
                ...
                <td style="font-size: 18px; color: #333; padding-left: 10px; padding:5px; border-left: 2px solid #0066cc;">{{ $request->grade ?? '' }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="font-size: 18px; color: #333; padding-left: 10px; padding:5px; border-left: 2px solid #0066cc;">{{ $request->reliabilityIndex ?? '' }}</td>
            </tr>
        </table>
        <hr style="margin-bottom: 10px;">
        <!-- Feedback Section -->
        <table style="width: 100%; margin-bottom: 30px;">
            ...
            <tr>
                 <td style="font-size: 18px; color: #333; padding-left: 10px; padding:5px; border-left: 2px solid #0066cc;">{{ $request->feedback ?? '' }}</td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin-top: 30px;">
            ...
            <tr>
                <td style="padding-top: 10px;">{{ $request->assignmentCntent ?? '' }}</td>
            </tr>
        </table>
    </div>
