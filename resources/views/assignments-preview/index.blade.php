            ...
            <div class="col-md-3 px-0">
                <div class="grade-sidebar ">
                    <div class="grade-header">
                        ...
                        {{-- <img src="{{asset('assets/images/grade.png')}}" class="img-fluid text-center grade-img" alt="grade"> --}}
                            ...
                            @isset($rubicFilesNames)
                                <div class="upload-btn-wrapper grade-wrap">
                                    ...
                                    <div class="custom-dropdown rubicFileNames" id="dropdown-menu">
                                        <ul>
                                            @foreach ($rubicFilesNames as $rubicFilesName)
                                                <li data-value="grade1">{{ $rubicFilesName ?? '' }}</li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
    ...
    function backBtn() {
        ...
        if (subject_id != "") {
            $.ajax({
                ...
                success: function(response) {
                    window.location.href = "{{ route('teacher.marks') }}";
